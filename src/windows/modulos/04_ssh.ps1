...
# Se eliminó la llamada directa "Menu-SSH" del final del archivo
...
function Configurar-Interfaz-SSH {
    ...
    Write-Host "La red de administración ha sido aislada en el segmento 100.0.0.0/24."
...
function Menu-SSH {
    $opciones_ssh = @(
        "Desplegar Red de Administración SSH (Ethernet 2)",
